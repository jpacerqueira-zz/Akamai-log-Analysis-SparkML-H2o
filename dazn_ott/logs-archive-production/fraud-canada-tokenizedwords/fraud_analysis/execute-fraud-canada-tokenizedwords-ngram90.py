...
#
# 
sc = pyspark.SparkContext(appName="Daily-TokenizedWords-Ngram90")
sqlContext = SQLContext(sc)
# 
#
#
input_file1="hdfs:///data/raw/ott_dazn/logs-archive-production/dt="+process_date+"/*.log.gz"
...
output_file2="hdfs:///data/staged/ott_dazn/fraud-canada-tokenizedwords-ngram-90/dt="+process_date
#
#
df2= sqlContext.read.json(input_file1)
df2.printSchema()
#
